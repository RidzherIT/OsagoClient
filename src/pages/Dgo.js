...
import dgoPolis from '../img/osago/dgoPolis.svg';
import dgoPhone from '../img/osago/dgoPhone.jpg';
...
export default observer(function Dgo() {
    const navigate = useNavigate();
    const polis = 'dgo';
    const polisTitle = 'ДГО';
    const polisType = '';
    const data = {
        polis,
        polisType,
                    ...
                    <div class="polis-main__inner">
                        ...
                        <div class="polis-main__content">
                            <div class="polis-main__top-right">
                                ...
                                <img src={dgoPhone} alt="" /><img src="" alt="" />
                            </div>
