...
import osagoPolis from '../img/osago/osagoPolis.svg';
import osagoPhone from '../img/osago/osagoPhone.jpg';
...
export default observer(function Osago() {
    const navigate = useNavigate();
    const polis = 'osago';
    const polisTitle = 'ОСАГО';
    const polisType = 'Автоцивілка';
    const data = {
        polis,
        polisType,
        polisTitle
                    ...
                    <div class="polis-main__inner">
                        ...
                        <div class="polis-main__content">
                            <div class="polis-main__top-right">
                                ...
                                <img class="polis-main__top-right__img-polis" src={osagoPolis} alt="" />
                                <img src={osagoPhone} alt="" /><img src="" alt="" />
                            </div>
