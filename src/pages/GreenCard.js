...
import greenCardPolis from '../img/osago/greenCardPolis.png';
...
export default observer(function GreenCard() {
    const navigate = useNavigate();
    const polis = 'greencard';
    const polisTitle = 'Зеленая карта';
    const polisType = 'Зеленая карта';
    const data = {
        polis,
        polisType,
        polisTitle
                    ...
                    <div class="polis-main__inner">
                        ...
                        <div class="polis-main__content">
                            <div class="polis-main__top-right">
                                <div class="polis-main__top-right__info wrapper-gradient pos-abs">
                                    <div>
                                ...
                                {/* <img class="polis-main__top-right__img-polis" src={dgoPolis} alt="" /> */}
                                <img src={greenCardPolis} alt="" /><img src="" alt="" />
                            </div>
